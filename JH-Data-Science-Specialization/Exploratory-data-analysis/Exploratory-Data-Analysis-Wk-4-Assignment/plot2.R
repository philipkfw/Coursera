# Exploratory Data Analysis - Wk 4 Assignment - Plot 2 --------------------
...
with(NEI_summary_Maryland_df, barplot(total_emissions, names.arg = year, xlab = "Year", main = "Total PM2.5 Emissions from Baltimore City, Maryland 1999-2008"))
dev.off()
